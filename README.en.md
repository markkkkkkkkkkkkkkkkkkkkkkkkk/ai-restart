...
**Telegram channel:** [@SiriAI_restart](https://t.me/SiriAI_restart) — release news and questions.

![The AI Restart menu and the battery menu](images/menus-en.png)

*On the left, the battery menu — where the charge is going. On the right, the app menu — the restart that turns Siri AI on.*
...
![The main menu](images/menu-en.png)
...
![The battery menu](images/battery-en.png)

*Time remaining, battery capacity, cycle count and the apps using the most energy.*
...
**The app's interface** is translated into seven languages: English, Russian, Ukrainian, Polish, Czech, Greek and Romanian. It picks one by itself from the saved return language and falls back to English when there is no translation. To choose by hand: **Settings → Interface Language**.

Everything except English and Russian was translated without native speakers. If a phrase reads wrong, [open an issue](../../issues/new/choose) and it will be fixed.
...
src/
  ...
  lib/
    ...
    i18n.js           every interface string: seven languages
